...
@CrossOrigin(origins="*")
@Slf4j
public class Ingredient2Controller {

  private IngredientRepository repo;

  @Autowired
  public Ingredient2Controller(IngredientRepository repo) {
    this.repo = repo;
  }
  ...
  //c15增加断路器注解
  @HystrixCommand(fallbackMethod="defaultById2",
			commandProperties = {
  ...
  @GetMapping("/{id}")
  public Optional<Ingredient> byId2(@PathVariable String id) throws InterruptedException {
	  log.info("开始执行byId方法");
	  //c15增加，让其超时
  ...
  //c15增加，断路器备用方法
  public Optional<Ingredient> defaultById2(String id) throws InterruptedException {
